...
try {
    ...
    $mail->Username   = 'bibliosantago@gmail.com';                     // SMTP username
    $mail->Password   = 'del1al13';                               // SMTP password
    //$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
    
    //Recipients
    $mail->setFrom('bibliosantago@gmail.com', 'Biblio Santago');
    $mail->addAddress($email, 'Biblio Santago');     // Add a recipient
